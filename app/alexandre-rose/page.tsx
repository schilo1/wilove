      ...
      <section className={styles.hero}>
        ...
        <div className={styles.couplePhotos}>
          <div className={styles.photoFrame}>
            <Image
              src="/clients_alexandre_rose/alexandre.png"
              alt="Photo de Jean"
              width={180}
              height={180}
          ...
          <div className={styles.photoFrame}>
            <Image
              src="/clients_alexandre_rose/rose.png"
              alt="Photo de Marie"
              width={180}
              height={180}
              className={styles.photoImage}
      ...
      <section className={styles.gallerySection}>
        ...
        <div className={styles.galleryGrid}>
          ...
          <GalleryItem
            ...
            imageSrc="/clients_alexandre_rose/photo5.PNG"
          />
        </div>
      </section>
