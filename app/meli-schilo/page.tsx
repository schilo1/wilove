    ...
    <div className={styles.container}>
      ...
      <section className={styles.hero}>
        ...
        <h1 className={styles.heroTitle}>
          Schilo <span>&</span> Mélissa
        </h1>
        <p className={styles.heroDate}>ENSEMBLE DEPUIS 10.12.2025</p>
        <p className={styles.heroQuote}>
          &ldquo;Dans tes yeux, j&apos;ai trouvé ma maison. Dans ton cœur,
          j&apos;ai trouvé mon amour. Dans ton âme, j&apos;ai trouvé mon
          meilleur ami et mon partenaire.&rdquo;
        </p>
      ...
      <section className={styles.timelineSection}>
        ...
        <div className={styles.timeline}>
          <TimelineItem
            date="2 Janvier 2026"
            title="Notre Premier Date de 2026"
            text="Le jour où nos chemins se sont croisés et où tout a changé pour toujours..."
            imageSrc="/images/date2.PNG"
          />
          <TimelineItem
            date="14 Novembre 2025"
            title="Notre Première Sortie Bassam"
            text="Une escapade romantique qui a scellé notre amour à jamais..."
            imageSrc="/images/date33.png"
          />
          <TimelineItem
            date="14 Février 2026"
            title="Deux mois d'Amour"
            text="Notre premier anniversaire, célébré sous les étoiles d'atmosphère..."
            imageSrc="/images/date4.png"
          />
          <TimelineItem
            date="09 Janvier 2026"
            title="Nos sorties Aleatoires"
            text="Les plus belle année de ma vie."
            imageSrc="/images/date5.png"
          />
        </div>
      </section>
      ...
      <section className={styles.gallerySection}>
        ...
        <div className={styles.galleryGrid}>
          <GalleryItem
            ...
            location="Villa Lana, 2025"
            imageSrc="/images/demande.JPG"
            large
          />
          <GalleryItem
            title="Vacances d'Été"
            location="Bassam, 2025"
            imageSrc="/images/date3.jpg"
          />
          <GalleryItem
            title="Premier Date de 2026"
            location="Atmosphère, 2026"
            imageSrc="/images/date2.PNG"
          />
          <GalleryItem
            title="La plus belle des femmes"
            location="Abidjan, 2025"
            imageSrc="/images/beautiful.jpg"
          />
          <GalleryItem
            title="Premieres fleures"
            location="Chez Toi, 2025"
      ...
      <section className={styles.letterSection}>
        ...
        <div className={styles.letterContainer}>
          ...
          <div className={styles.letterSignature}>
            ...
            <p className={styles.name}>Schilo</p>
          </div>
      ...
      <footer className={styles.footer}>
        ...
        <p className={styles.footerNames}>Schilo ♥ Mélissa</p>
        <p className={styles.footerCredit}>Créé avec amour • 2026</p>
      </footer>
